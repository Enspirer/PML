...
<form action="{{route('admin.free_listning.update')}}" method="post" enctype="multipart/form-data">
{{csrf_field()}}
    <div class="row">
        <div class="col-7">  
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div>
                                    ...
                                    <textarea class="form-control" name="meta_description" id="meta-description" aria-describedby="meta-description" required>{{ $property->meta_description }}</textarea>
                                </div>
                            </div>
                            <div class="col-6">
                                <div>
                ...
                <div class="card-body">
                    <div class="" style="border-style: ridge;border-width: 3px;padding: 20px;">
                        ...
                        <div class="mt-5 text-center">
                            ...
                            <a href="{{route('admin.free_listning.index')}}" type="button" class="btn rounded-pill text-light px-4 py-2 me-2 btn-primary">Back</a>

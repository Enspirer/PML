    ...
    <div class="row">
        <div class="col-12">
            <p><a href="" class="text-decoration-none text-dark fw-bold">Property Market Live</a>
                ...
                > <a href="" class="text-decoration-none text-dark fw-bold">Result</a>
            </p>
        </div>
    </div>
</div>
                        ...
                        <div class="for-sale-card-body-mobile card-body mt-2">
                            <div class="row mb-2">
                                ...
                                <div class="col-1" style="display:flex; justify-content:center;">
                                    ...
                                    {
                                    $favourite =
                                    App\Models\Favorite::where('property_id',$property_pro->id)->where('user_id',auth()->user()->id)->first();
                                    }else{
                                    $favourite = null;
                                    }
                                    @endphp
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        {
                                        $favourite =
                                        App\Models\Favorite::where('property_id',$normal->id)->where('user_id',auth()->user()->id)->first();
                                        }else{
                                        $favourite = null;
                                        }
                                        @endphp
        ...
        <div class="col-3 col-xs-12 col-tab-50 tab-center tab-mb-30">
            ...
            <div class="row sidebar-card-area">
                <div class="col-12 p-0 mb-4 custom-shadow">
                    <div class="card">
                        <img src="{{ uploaded_asset(get_settings('property_page_advertiment_1')) }}" class="img-fluid"
                            alt="..." style="">
                ...
                <div class="col-12 p-0 mb-4 custom-shadow">
                    <div class="card">
                        <img src="{{ uploaded_asset(get_settings('property_page_advertiment_2')) }}" class="img-fluid"
                            alt="..." style="">
                        <div class="card-body text-end">
                ...
                <div class="col-12 p-0 custom-shadow">
                    <div class="card">
                        <img src="{{ uploaded_asset(get_settings('property_page_advertiment_3')) }}" class="img-fluid"
                            alt="..." style="">
                        <div class="card-body text-end">

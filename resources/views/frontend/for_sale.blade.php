    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-9">
                ...
                <div class="row" style="margin-top: 5rem; margin-bottom: 8rem;">
                    <div class="col-12">
            ...
            <div class="col-3">
                <div class="row justify-content-center custom-shadow p-3 mb-4">
                    <div class="col-12 text-center">
                        <a href="#" class="btn py-2 fw-bold text-white w-75 rounded-pill" style="border: 1.5px solid #707070; background-color: #35495E"><i class="fas fa-envelope me-2"></i> Create email alert</a>
                    </div>
                    <div class="col-12 text-center mt-4">
                        <a href="" class="btn py-2 fw-bold w-75 rounded-pill" style="border: 1.5px solid #707070"><i class="far fa-heart me-2"></i> Save this Search</a>
                    </div>
                </div>

...
<head>
    ...
    <link rel="stylesheet"
        href="https://demo.noxls.net/google-map-clustering-v3//static/plugins/leaflet-sidebar/css/gmaps-sidebar.min.css">
    <link type="text/css" rel="stylesheet"
        href="https://demo.noxls.net/google-map-clustering-v3//static/css/style.css" />
    <script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
    <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    <script src="https://demo.noxls.net/google-map-clustering-v3//static/plugins/leaflet-sidebar/js/jquery-sidebar.js">
    </script>
    <script src="https://demo.noxls.net/google-map-clustering-v3//static/js/jquery.form.js" type="text/javascript">
    </script>
    <!-- Google Tag Manager -->
    <script>
    (function(w, d, s, l, i) {
    ...
    })(window, document, 'script', 'dataLayer', 'GTM-58NHVD8');
    </script>
...
<body>
            ...
            <div class="sidebar-pane" id="home">
                ...
                <div class="panel-body">
                    <label>
                        ...
                        checkboxClicked();" type="checkbox" name="check_all" id="check_all" value="-1"> Check All
                    </label>
                    <div class="checkbox" style="height: 880px; overflow-y: scroll;">
                        <label style="margin-right: 9px; margin-bottom: 10px;">
                            ...
                            <img src="{{ url('img/frontend/map/icons/2.png') }}" alt="unknown" title="unknown">
                            unknown</label>
                        <br>
                        <label style="margin-right: 9px; margin-bottom: 10px;">
                            <input checked="checked" onclick="checkboxClicked();" type="checkbox" value="3">
                            <img src="{{ url('img/frontend/map/icons/3.png') }}" alt="station" title="station"> station
                        </label>
                        <br>
                        <label style="margin-right: 9px; margin-bottom: 10px;">
                        ...
                        <label style="margin-right: 9px; margin-bottom: 10px;">
                            ...
                            <img src="{{ url('img/frontend/map/icons/14.png') }}" alt="Building" title="Building">
                            Building </label>
                        <br>
                        <label style="margin-right: 9px; margin-bottom: 10px;">
                            <input checked="checked" onclick="checkboxClicked();" type="checkbox" value="15">
                            <img src="{{ url('img/frontend/map/icons/15.png') }}" alt="Gas Station" title="Gas Station">
                            Gas Station </label>
                        <br>
                        <label style="margin-right: 9px; margin-bottom: 10px;">
                ...
                <div class="navbar-offcanvas offcanvas">
                    ...
                    <ul class="nav navbar-right">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li>
                                <a href="https://demo.noxls.net/google-map-clustering-v3/login.php">Login</a>
                            </li>
                            ...
                            <button type="button" class="btn btn-success mt10"
                                onclick="window.location='https://noxls.net/products/google-map-clustering'">Back to
                                Item</button>
                        </ul>
                ...
                <div class="panel panel-primary  ">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <form class="navbar-form navbar-left form-inline" role="search"
                                action="https://demo.noxls.net/google-map-clustering-v3/manage.php">
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="search" class="form-control" width="250" id="search"
                                            name="search_text" value="" placeholder="Search text">
                                        <span class="input-group-btn">
                                            <button class="btn btn-default" id="clear-search-btn" type="button"><i
                    ...
                    <ul class="list-group">
                        <li class='list-group-item'>
                            <a href="#" class="btn btn-default" id="list-markers-prev"><i
                                    class="glyphicon glyphicon-chevron-left"></i></a>
                            <a href="#" class="btn btn-default" id="list-markers-next"><i
    ...
    var HTTP_APP_PATH = 'http://localhost:8000/test';
    var ZOOM = 5;
    ...
    var MAP_SETTINGS = {
        "jsonGetMarkerUrl": "http:\/\/localhost:8000\/api\/test-markers",
        "jsonMarkerUrl": "http:\/\/localhost:8000\/api\/test-markers",
        "jsonGetMarkerInfoUrl": "http:\/\/localhost:8000\/api\/test-markers",
        "jsonMarkerInfoUrl": "http:\/\/localhost:8000\/api\/test-markers",
        "clusterImage": {
            "src": "http:\/\/demo.noxls.net\/google-map-clustering-v3\/\/static\/img\/cluster2.png",
            "height": 60,
            "width": 60,
            "offsetH": 30,
            "offsetW": 30
        ...
        "pinImage": {
            "2": {
                "type_name": "unknown",
                "src": "http:\/\/demo.noxls.net\/google-map-clustering-v3\/\/static\/img\/ico\/2.png",
                "height": 37,
                "width": 32,
                "offsetH": 0,
                "offsetW": 0
            ...
            "3": {
                "type_name": "station",
                "src": "https:\/\/demo.noxls.net\/google-map-clustering-v3\/\/static\/img\/ico\/3.png",
                "height": 37,
                "width": 32,
                "offsetH": 0,
                "offsetW": 0
            ...
            "4": {
                "type_name": "port",
                "src": "https:\/\/demo.noxls.net\/google-map-clustering-v3\/\/static\/img\/ico\/4.png",
                "height": 37,
                "width": 32,
                "offsetH": 0,
                "offsetW": 0
            ...
            "5": {
                "type_name": "zb",
                "src": "https:\/\/demo.noxls.net\/google-map-clustering-v3\/\/static\/img\/ico\/5.png",
                "height": 32,
                "width": 32,
                "offsetH": 0,
                "offsetW": 0
            ...
            "14": {
                "type_name": "Building",
                "src": "https:\/\/demo.noxls.net\/google-map-clustering-v3\/\/static\/img\/ico\/14.png",
                "height": 37,
                "width": 32,
                "offsetH": 0,
                "offsetW": 0
            ...
            "15": {
                "type_name": "Gas Station",
                "src": "https:\/\/demo.noxls.net\/google-map-clustering-v3\/\/static\/img\/ico\/15.png",
                "height": 37,
                "width": 32,
                "offsetH": 0,
                "offsetW": 0
            ...
            "22": {
                "type_name": "banc",
                "src": "https:\/\/demo.noxls.net\/google-map-clustering-v3\/\/static\/img\/ico\/22.png",
                "height": 37,
                "width": 32,
                "offsetH": 0,
                "offsetW": 0
            ...
            "23": {
                "type_name": "aaa",
                "src": "https:\/\/demo.noxls.net\/google-map-clustering-v3\/\/static\/img\/ico\/23.",
                "height": 0,
                "width": 0,
                "offsetH": 0,
                "offsetW": 0
            ...
            "24": {
                "type_name": "aaa",
                "src": "https:\/\/demo.noxls.net\/google-map-clustering-v3\/\/static\/img\/ico\/24.",
                "height": 0,
                "width": 0,
                "offsetH": 0,
                "offsetW": 0
    ...
    <script type="text/javascript"
        src="https://maps.google.com/maps/api/js?key=AIzaSyDpIH3JYQy5cayMmoaP1JHpp5jHUwYe0JQ&language=en"></script>
    ...
    <script type="text/javascript"
        src="{{ url('js/mapclustering-normal.js')}}"></script>
    <div id="fb-root"></div>
    <script>
    (function(d, s, id) {
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-58NHVD8" height="0" width="0"
